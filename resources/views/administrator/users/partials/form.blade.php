...
<div class="radio" id="password_type_div">
    <p>Password Creation</p>
<label>
    <input type="radio" name="password_type" value="auto-create" checked>
    Auto-Generate Password
</label>
<br>
<label>
    <input type="radio" name="password_type" value="manual-creation">
...
<div class="form-group" id="password_retype_div">
    {!! Form::label('points', 'Retype Password') !!}
