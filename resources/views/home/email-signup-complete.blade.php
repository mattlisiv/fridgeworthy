...
<div class="mainwrap">
    ...
    <section id="listtemplatecnt">
        <div class="listtable">
            <div class="listtabletitle">Your Email Has Been Added.</div>
            ...
            <div>
                <div style="color: #ffffff;font-size:14px;font-family: 'ralewaylight', Helvetica, sans-serif;width:75%;margin: 0 auto">
                    ...
                    <div>
                        ...
                        <br>
                        <br>
                        <h5>Your email has been added. You will now receive updates from FridgeWorthy.</h5>
                        <br>
                        <h6>Thanks for all your support!</h6>
                        <br>
                        <br>
                        <br>
