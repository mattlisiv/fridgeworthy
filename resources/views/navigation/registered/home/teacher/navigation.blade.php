            ...
            <ul>
                ...
                <li><a href="{{action('StaticPagesController@infographic')}}">about us</a>
                    <ul class="dropdownmenu">
                        <li><a href="{{action('StaticPagesController@teacherPointSystemInfographic')}}" >how to earn points</a></li>
                    </ul>
                </li>
                ...
                <div class="menu-header">
                    <ul id="menu-mobile-menu" class="menu">
                        ...
                        <li class="menu-item menu-item-has-children"><a href="{{action('StaticPagesController@infographic')}}">about us</a>
                            <ul class="sub-menu">
                                <li class="menu-item"><a href="{{action('StaticPagesController@teacherPointSystemInfographic')}}">how to earn points</a></li>
                            </ul>
                        </li>
