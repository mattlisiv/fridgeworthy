...
<div class="mainwrap">
    ...
    <section id="listtemplatecnt">
        <div class="listtable">
            <div class="listtabletitle">Student Confirmed</div>
            ...
            <div>
                <div style="color: #ffffff;font-size:14px;font-family: 'ralewaylight', Helvetica, sans-serif;width:75%;margin: 0 auto">
                    ...
                    <div>
                        ...
                        <br>
                        <br>
                        <h5>Your student has been confirmed to your account. You can now view your student's grades and earn rewards.</h5>
                        <br>
                        <br>
                        <br>
