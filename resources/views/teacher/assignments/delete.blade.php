...
<div class="mainwrap">
    ...
    <section id="listtemplatecnt">
        <div class="listtable">
            <div class="listtabletitle">Delete An Assignment</div>
                <br>
                ...
                <div style="color: #ffffff;font-size:14px;font-family: 'ralewaylight', Helvetica, sans-serif;width:75%;margin: 0 auto">
                    ...
                    <div id="delete" style="display:none">
                        {!! Form::open(['url'=>'destroy_assignment']) !!}
                        <div>
                            <br>
                            <h6>Are you sure you would like to delete this assignment?
                                <br>
                                By deleting this assignment, all associated grades will also be deleted.
                            </h6>
                                                  <br>
                        </div>
                    ...
                    <div id="deleteDisplay">
                        <br>
                        <h6>By deleting an assignment, you will be removing all associated grades.</h6>
                        <br>
                        <h5>Select Assignment</h5>
                        <br>
                        <h6>{!! Form::select('assignment_id',array('default'=>'Please Select ') +$assignments->lists('name','id'), 'default',
                            ['class'=>'customSelect','style'=>'text-indent:10px']) !!}</h6>
                        <br>
                        <br>
                    {!! Form::close()!!}
                        <button class="classdetbtn" onclick="displayDelete()">Delete Assignment</button>
                        <br>
                        <br>
                        @if($errors)
